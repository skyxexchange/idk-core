...
(function (NativeCurrencyName) {
  ...
  // BASE = 'ETH',
  NativeCurrencyName["BASE_TESTNET"] = "ETH";
...
var CHAIN_TO_ADDRESSES_MAP = (_CHAIN_TO_ADDRESSES_M = {}, _CHAIN_TO_ADDRESSES_M[ChainId.BASE_TESTNET] = BASE_TESTNET_ADDRESSES, _CHAIN_TO_ADDRESSES_M);
...
var MULTICALL_ADDRESSES = /*#__PURE__*/_extends({}, /*#__PURE__*/SUPPORTED_CHAINS.reduce(function (memo, chainId) {
  var multicallAddress = CHAIN_TO_ADDRESSES_MAP[chainId].multicallAddress;
  if (multicallAddress) {
...
var SWAP_ROUTER_02_ADDRESSES = /*#__PURE__*/_extends({}, /*#__PURE__*/SUPPORTED_CHAINS.reduce(function (memo, chainId) {
  var swapRoutersAddress = CHAIN_TO_ADDRESSES_MAP[chainId].swapRouter02Address;
 ...
 */
var WETH9 = (_WETH = {}, _WETH[84531] = /*#__PURE__*/new Token(84531, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapped ETH'), _WETH);
...
export { CHAIN_TO_ADDRESSES_MAP, ChainId, CurrencyAmount, Ether, Fraction, MULTICALL_ADDRESSES, MaxUint256, NONFUNGIBLE_POSITION_MANAGER_ADDRESSES, NativeCurrency, NativeCurrencyName, Percent, Price, QUOTER_ADDRESSES, Rounding, SUPPORTED_CHAINS, SWAP_ROUTER_02_ADDRESSES, TICK_LENS_ADDRESSES, Token, TradeType, V3_CORE_FACTORY_ADDRESSES, V3_MIGRATOR_ADDRESSES, WETH9, computePriceImpact, sortedInsert, sqrt, validateAndParseAddress };
